...
void SysTick_Handler(void)
{
  /* USER CODE BEGIN SysTick_IRQn 0 */
	...
	//	static uint32_t teller_shiftUT = 0;
	//	teller_shiftUT++;
	//	if (teller_shiftUT <= 1){
	//		//teller_shiftUT = 0;
	//		shiftUT();
	...
	if (MOTTATT_THRUST){
		...
		// if((operator_referanse_int.reg_deaktiver & 0x01)) -> filterer ut bit 1 og sjekker om lik 1.
		// if(!(operator_referanse_int.reg_deaktiver & 0x01)) -> filterer ut bit 1 og sjekker om lik 0.
		// !(operator_referanse.reg_deaktiver) -> sjekker om lik 0
