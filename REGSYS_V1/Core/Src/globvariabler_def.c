 ...
 *
 * ---->> trenger dek/def i filnavn er overflødig h/c henviser til dette.
 *
 */
...
////////////// BIT PATTERNS
uint16_t VB = 0b0000000000000001;
uint16_t VF = 0b0000000001000000;
uint16_t HF = 0b0000000000010000;
uint16_t HB = 0b0000000000000100;


uint16_t HIVREF = 0;
uint8_t HIVREF10 = 0;
uint8_t	HIVREFm = 0;
uint8_t FELICESPERDIDOS = 7;
uint8_t FELICESPERDIDOSNR2 = 7;
uint8_t LITEN_SJEKK = 0;
...
//////// FOR REGULERING
PID_var_felles PID_felles =  {0.05,0.9};
